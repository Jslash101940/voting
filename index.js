field.onclick = function (event){
    ...
    let fieldCoordes = this.getBoundingClientRect();
    console.log(field.clientTop)
    //clientTopmeans boarder
    let ballCoords = {
        top: event.clientY - fieldCoordes.y - field.clientTop - ball.clientHeight/2,
        left: event.clientX - fieldCoordes.x - field.clientLeft - ball.clientWidth/2
    }

    //prent the ball from going out of bounds
